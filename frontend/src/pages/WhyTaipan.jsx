    ...
    <>
      ...
      <section className="why-section why-section--dark why-fade-in">
        <div className="container">
          ...
          <p className="why-text">
            Каждый сезон подводятся итоги — в конце мая.
          </p>
          <p className="why-text">
            Абсолютные чемпионы клуба по итоговому рейтингу
            попадают в Зал Славы на сайте — их фото и достижения
            представлены на весь следующий сезон.
          </p>
          <p className="why-text">
            Лучшие в своих возрастных категориях и победители
            по системе ачивок получают награждение на торжественной
            церемонии закрытия сезона.
          </p>
          <p className="why-text">
            Новый сезон — новые цели, новые герои.
          </p>

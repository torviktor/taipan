...
export function AnalyticsInfoBlock() {
  return (
    <div style={{ marginBottom: 32 }}>
      ...
      <P>
        Платформа накапливает данные по каждому спортсмену: посещаемость тренировок, результаты
        соревнований, прогресс по аттестациям, участие в сборах. Это не просто архив —
        это основа для осмысленных выводов о развитии бойца. Мы знаем, как превратить
        эти данные в пользу.
      </P>

      <H3>Что входит в аналитику</H3>
      {[
        ['Посещаемость', 'динамика активности по сезонам, пропуски, тренды'],
        ['Соревнования', 'частота участия, результативность, динамика мест, сравнение по возрастной категории'],
        ['Сборы', 'участие, периодичность, связь с результатами соревнований'],
        ['Аттестации', 'темп продвижения по поясам, интервалы между аттестациями'],
        ['Связи и зависимости', 'как посещаемость влияет на результат, как сборы связаны с ростом уровня'],
        ['Антропометрия', 'соответствие возрасту и росту, рекомендации по весовой категории'],
        ['Индивидуальные рекомендации', 'конкретные выводы под возраст, уровень и цели спортсмена'],
      ].map(([name, desc]) => (
      ...
      <H3>Как часто проводить</H3>
      <P>
        Аналитика — не еженедельный отчёт. Смысл появляется, когда данных достаточно.
        Рекомендация: <Hl>раз в год</Hl> — всем активным спортсменам.{' '}
        <Hl>Раз в полгода</Hl> — тем, кто регулярно участвует в соревнованиях и сборах.
        Делать её чаще — значит анализировать одно и то же.
      </P>

      <H3>Почему это платно</H3>
      <P>
        Каждая аналитика — это ручная работа, а не автоматический отчёт. Аналитик —
        сертифицированный специалист, при этом глубоко интегрированный в тхэквондо:
        знает специфику тренировочного процесса, структуру соревнований, систему поясов
        и возрастных категорий. Это не сторонний взгляд — это взгляд изнутри,
        переведённый в цифры.
      </P>
      <P>
        Бесплатно — значит «когда успею». Платный формат — это гарантия срока, структуры
        и реальной пользы. Иначе запросы утонут.
      </P>

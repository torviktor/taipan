...
camps: (
  <div className="about-body">
    ...
    <div className="about-principles">
      <div className="about-principle">
        <span className="about-principle-num">01</span>
        <div><strong>Внутриклубные турниры</strong><p>Первый шаг к опыту выступлений. Отличная возможность преодолеть страх сцены.</p></div>
      </div>
      <div className="about-principle">
        <span className="about-principle-num">02</span>
        <div><strong>Муниципальные и окружные соревнования</strong><p>Турниры под эгидой Федерации тхэквондо ГТФ Московской области.</p></div>
      </div>
      <div className="about-principle">
        <span className="about-principle-num">03</span>
    ...
    <p>Турниры проводятся по дисциплинам: туль (формальные комплексы), спарринг (поединок с защитой и судейством), силовые и технические тесты.</p>

...
camps: (
  <div className="about-body">
    ...
    <div style={{ marginBottom:32 }}>
      <img src="/camps4.webp" alt="Сборы" style={{ width:'100%', height:260, objectFit:'cover', objectPosition:'center top', display:'block' }} />
    </div>
    ...
    <div className="about-principles">
      <div className="about-principle">
        <span className="about-principle-num">01</span>
        <div><strong>Внутриклубные турниры</strong><p>Первый шаг к опыту выступлений. Отличная возможность преодолеть страх спарринга.</p></div>
      </div>
      <div className="about-principle">
        <span className="about-principle-num">02</span>
        <div><strong>Муниципальные и окружные соревнования</strong><p>Турниры под эгидой региональной Федерации тхэквондо ГТФ России.</p></div>
      </div>
      <div className="about-principle">
        <span className="about-principle-num">03</span>
        <div><strong>Открытые турниры и кубки</strong><p>Спортсмены из других регионов и клубов. Новый уровень сложности и вызова.</p></div>
      </div>
      <div className="about-principle">
        <span className="about-principle-num">04</span>
        <div><strong>Чемпионаты и первенства</strong><p>Для опытных спортсменов с высокими поясами. Строгие требования к экипировке, заявка через Федерацию.</p></div>
      </div>
    </div>

    <p>Турниры проводятся по дисциплинам: туль/хъёнг (формальные комплексы), массоги (спарринги в полный контакт с ограничениями), стоп-балл (поединки с остановкой после каждого точного удара для начисления очков), силовое разбивание (киок-па) и специальная техника. Соревнования проходят в личных и командных зачётах.</p>
    <p>Перед соревнованиями тренер помогает выбрать дисциплину, готовит спортсмена по технике и тактике, контролирует оформление заявки и экипировку.</p>

    <h3>Поддержка родителями</h3>
    <p>Родители играют очень важную роль в подготовке детей к сборам и соревнованиям:</p>
    <ul>
      ...
      <li>поддерживают психологически, помогают справиться с волнением</li>
      <li>учат радоваться опыту, а не только результату</li>
    </ul>

    <div className="about-quote">
      <p>Задача родителя — не давить на результат, а быть рядом и помогать ребёнку быть уверенным в себе.</p>
    </div>

    <div className="about-cta">
      Сборы и соревнования — это момент, когда ученик может проявить себя, испытать свои силы и почувствовать радость настоящего прогресса. Это важные ступени взросления — как в тхэквондо, так и в жизни.
    </div>

...
members: (
  <div className="about-body">
    ...
    <p>Мы не «принимаем ребёнка в секцию» — мы вместе растим личность. Тренер и родители — одна команда, которая стоит за спиной каждого ребёнка.</p>
...
attestation: (
  <div className="about-body">
    ...
    <p>Перед экзаменом тренер проводит <strong>предаттестационную проверку</strong> — своего рода «репетицию», на которой принимается решение о допуске.</p>

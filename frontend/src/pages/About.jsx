...
competitions: (
  <div className="about-body">
    ...
    <p>Спортсмены разделяются по возрасту, весовым категориям и уровню пояса. Поединок ведётся в три раунда, победитель определяется по очкам или нокдауну. Судьи оценивают чистоту техники, а не грубую силу — это принципиальное отличие тхэквондо от других единоборств.</p>
    ...
    <div className="about-cta">
      Соревнования в «Тайпане» — это не обязательство, а возможность. Каждый спортсмен выходит на татами тогда, когда готов. И мы гордимся каждым, кто решается сделать этот шаг.
    </div>

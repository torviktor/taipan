...
about: (
  <div className="about-body">
    ...
    <div className="about-lead">
      <p>Наш клуб — официально зарегистрированное юридическое лицо. 20 июля 2026 года в Единый государственный реестр юридических лиц внесена запись о создании Автономной некоммерческой организации «Спортивный клуб тхэквондо «Тайпан» города Павловский Посад» (АНО «СКТ «Тайпан» г. Павловский Посад»). Регистрация проведена Управлением ФНС России по Московской области на основании распоряжения Управления Минюста России по Московской области.</p>
      ...
      <p>Основной вид деятельности организации — деятельность спортивных клубов (ОКВЭД 93.12). Мы работаем полностью в правовом поле: устав, государственная регистрация, некоммерческий статус — всё это значит, что клуб существует ради развития тхэквондо и своих воспитанников, а не ради извлечения прибыли.</p>
      <div style={{ marginTop:16, paddingTop:16, borderTop:'1px solid rgba(204,0,0,0.15)' }}>
        <p style={{ color:'var(--gray)', fontSize:'14px', marginBottom:4 }}>ОГРН: 1265000050556</p>
        <p style={{ color:'var(--gray)', fontSize:'14px', marginBottom:4 }}>ИНН: 5034074017</p>
        <p style={{ color:'var(--gray)', fontSize:'14px', marginBottom:4 }}>КПП: 503401001</p>
        <p style={{ color:'var(--gray)', fontSize:'14px', marginBottom:0 }}>Генеральный директор: Ротарь Екатерина Валерьевна</p>
      </div>
      <div style={{ marginTop:16, paddingTop:16, borderTop:'1px solid rgba(204,0,0,0.15)' }}>
    ...
    <p>Клубом руководит и лично тренирует <strong>Ротарь Екатерина Валерьевна</strong> — опытный тренер и мама, которая понимает родителей с полуслова.</p>
...
competitions: (
  <div className="about-body">
    ...
    <div className="photo-grid-6" style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:4, margin:'24px 0 32px' }}>
      ...
      <img src="/sparring4.webp" alt="Спарринг" style={{ width:'100%', height:220, objectFit:'cover', display:'block' }} />
      <img src="/sparring5.webp" alt="Спарринг" style={{ width:'100%', height:220, objectFit:'cover', display:'block' }} />
      <img src="/sparring6.webp" alt="Спарринг" style={{ width:'100%', height:220, objectFit:'cover', display:'block' }} />
    </div>

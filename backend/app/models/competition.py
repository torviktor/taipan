...
class CompetitionResult(Base):
    ...
    powerbreak           = Column(Boolean, nullable=False, default=False)
    spectech             = Column(Boolean, nullable=False, default=False)
    sparring_disabled    = Column(Boolean, nullable=False, default=False)
    stopball_disabled    = Column(Boolean, nullable=False, default=False)
    tegtim_disabled      = Column(Boolean, nullable=False, default=False)
    tuli_disabled        = Column(Boolean, nullable=False, default=False)
    powerbreak_disabled  = Column(Boolean, nullable=False, default=False)
    spectech_disabled    = Column(Boolean, nullable=False, default=False)

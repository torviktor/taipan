...
# ══════════════════════════════════════════════════════════════════════════════
# FeeDeadline и MonthlyFee — ВЫВЕДЕНЫ ИЗ ЭКСПЛУАТАЦИИ 25.08.2026
# ══════════════════════════════════════════════════════════════════════════════
#
# Взносы клуб ведёт в AthleteFeePeriod (см. выше). Эти две таблицы — вторая,
# параллельная система учёта: на день вывода в ней 165 начислений на 247 500 ₽
# и НИ ОДНОЙ отметки об оплате, один дедлайн от 07.04.2026.
#
# Пустая она не потому, что ей не успели воспользоваться, а потому что клуб
# работает в другой. Любой расчёт по ней даёт «должны все» — именно это и
# случилось: родитель видел в кабинете «ПРОСРОЧЕНО» за все месяцы, бот называл
# выдуманный долг, счётчик показывал 55 должников вместо 29.
#
# НЕ БЕРИТЕ ЭТИ МОДЕЛИ ДЛЯ РАСЧЁТА ВЗНОСОВ. Имя MonthlyFee выглядит подходящим,
# и меня оно тоже обмануло. Нужный источник — AthleteFeePeriod, готовые
# выборки — app/services/money.py.
#
# Данные и таблицы намеренно сохранены: место копеечное, удаление необратимо.
# Отключены генерация, рассылка и создание дедлайнов — см. app/routes/fees.py.
